...
namespace Festispec_WPF.ViewModel
{
    public class NAW_KlantVM
    {
        ...
        {
            get => _NAW_Klant.Vestigingsnummer;
            set => _NAW_Klant.Vestigingsnummer = value;
        }

        public string StreetName
        {
            get => _NAW_Klant.Straatnaam;
